...
;(function($){
  ...
  $.movingBoxes = function(el, options){
    ...
    base.update = function(callback, flag){
      ...
      base.$wrap.css('max-width', base.width); // set wrapper width
    ...
    base.growBigger = function(num, time, flag){
        ...
        base.threedee(num); // siteset custom function to do 3d transforms
      if (o.reducedSize === 1) {
    ...
    base.threedee = function(num){
        base.$panels.removeClass('pv2 pv cu nx nx2');
        var panels = base.$panels.eq(num - base.adj).addClass('cu'),
        pv = panels.prev().addClass('pv'),
        nx = panels.next().addClass('nx'),
        pv2 = pv.prev().addClass('pv2'),
        nx2 = nx.next().addClass('nx2');
    }
...
// end plugin code, begin in-page code
